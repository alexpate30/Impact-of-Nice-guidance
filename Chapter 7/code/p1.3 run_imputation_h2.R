...
start_time <- Sys.time()
mice2<-(foreach(seed.num=c(110,111,112,113,114,115,116,117,118,119), .combine=list, .multicombine=TRUE, 
...
## Save image
rm(list=setdiff(ls(),list("data","mice2")))
save.image("R_out_Vis2019/imputation_h2.RData")
