...
CKD_stage45_A.l<-parLapply(cl, list(mydataA1,mydataA2,mydataA3,mydataA4,mydataA5,mydataA6,mydataA7,mydataA8,mydataA9,mydataA10,
...
CKD_stage45_A<-bind_rows(CKD_stage45_A.l[[1]],CKD_stage45_A.l[[2]],CKD_stage45_A.l[[3]],CKD_stage45_A.l[[4]],
                          CKD_stage45_A.l[[5]],CKD_stage45_A.l[[6]],CKD_stage45_A.l[[7]],CKD_stage45_A.l[[8]],
                          CKD_stage45_A.l[[9]],CKD_stage45_A.l[[10]],CKD_stage45_A.l[[11]],CKD_stage45_A.l[[12]],
                          CKD_stage45_A.l[[13]],CKD_stage45_A.l[[14]],CKD_stage45_A.l[[15]],CKD_stage45_A.l[[16]],
                          CKD_stage45_A.l[[17]],CKD_stage45_A.l[[18]],CKD_stage45_A.l[[19]],CKD_stage45_A.l[[20]])

save.image("CKD_stage45_A_image.RData")
#load("CKD_stage45_A_image.RData")

write.csv(CKD_stage45_A,file="/mnt/ja01-home01/mbrxsap3/phd_risk/csv_data/p2_derive_variables/CKD_stage45_A_fromR.csv")
